...
CREATE TABLE `sugang` (
  ...
  KEY `classNo` (`classNo`),
  CONSTRAINT `sugang_ibfk_1` FOREIGN KEY (`studentNo`) REFERENCES `student` (`studentNo`),
  CONSTRAINT `sugang_ibfk_2` FOREIGN KEY (`classNo`) REFERENCES `class` (`classNo`)
...
INSERT INTO `sugang` VALUES (1,20191234,2),(2,20201234,1),(3,20211234,3);
...
-- Dump completed on 2022-11-15  0:37:13
